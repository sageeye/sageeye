...
import PortfolioSlider from "~components/lib/Slider/PortfolioDetailsOne/PortfolioSlider";
const ContentSection = () => {
  return (
    <div className="protfoliocontent-section-02">
      <div className="container">
        <div className="row">
          <div className="col-lg-12">
            <div className="protfoliocontent-section-02__slider">
              <PortfolioSlider />
            </div>
          </div>
          <div className="col-lg-12">
            <div className="protfoliocontent-card--02">
              <div className="row justify-content-center">
                <div className="col-xl-5 col-lg-5 mb-mobile-lg">
                  <div className="protfoliocontent-card--02__content">
                    ...
                    <div className="protfoliocontent-section-02__next-prev-button">
                ...
                <div className="col-xl-6 offset-xl-1 col-lg-7">
                  <ul className="protfoliocontent-card--02__list">
