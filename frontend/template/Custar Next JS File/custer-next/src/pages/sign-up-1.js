...
export default function SignUpOne() {
  return (
    ...
    >
      <AccountLayoutOne className="signup-section-01" title="Create your account">
        <form action="#" className="from w-100">
          ...
          <div className="from__check">
            <h6 className="from__check--title text-dark mb-3">
              Terms &amp; Conditions
            </h6>
            <input
          ...
          <div className="from__button-group">
            ...
            <div className="from__button-group--two">
              ...
              <Link className="createanaccout-btn" to="/sign-in-1">Sign in now
              </Link>
            </div>
          </div>
        </form>
